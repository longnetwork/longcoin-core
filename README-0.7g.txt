...
- Фикс листинга транзакций для адресов p2sh с данными на образующий адрес
...
- dumppubkey адаптирована для выдачи публичных ключей чужих адресов сохраненных через storeaddress
