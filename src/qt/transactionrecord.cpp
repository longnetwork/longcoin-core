...
//                                printf("QT Crypt Block of Get in: if (nNet > 0 || wtx.IsCoinBase())...if (mine)...\n");
                            }
...
//                            #warning DEBUG QT Crypt Block
//                            printf("QT Crypt Block of Get in: else... if (fAllFromMe && fAllToMe)...\n");
                        }
...
//                                #warning DEBUG QT Crypt Block
//                                printf("QT Crypt Block of Get in: else if (fAllFromMe)...if(wallet->IsMine(txout))...\n");
                            }
...
//                                #warning DEBUG QT Crypt Block
//                                printf("QT Crypt Block of Get in: else if (fAllFromMe)...if (ExtractDestination(txout.scriptPubKey, address))\n");
                            }
...
//                            #warning DEBUG QT Crypt Block
//                            printf("QT Crypt Block of Get in: else if (fAllFromMe) else...\n");
                        }
