...
void TransactionView::showDetails()
{
    ...
    if(!selection.isEmpty())
    {
        ...
        connect(&dlg, SIGNAL(replyToPushButtonClicked(const QString &)), this, SLOT(onReplyToPushButtonClicked(const QString &)));
        dlg.exec();
    }
}


void TransactionView::onReplyToPushButtonClicked(const QString &pubKeyHex)
{
    Q_EMIT replyToPushButtonClicked(pubKeyHex);
}
