...
public Q_SLOTS:
    void onReplyToPushButtonClicked(const QString &pubKeyHex);
...
Q_SIGNALS:
    ...
    void incomingTransaction(const QString& date, int unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& pubKeyHex);
};
