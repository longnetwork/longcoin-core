...
/** Ссылка на CScript: Hash160 его сериализации (см. Скрипт.h) */
...
static const unsigned int MAX_OP_RETURN_RELAY = 65535; //344; //! bytes (+1 for OP_RETURN, +2 for the pushdata opcodes) //! байты (+1 для OP_RETURN, +2 для кодов операций pushdata)
