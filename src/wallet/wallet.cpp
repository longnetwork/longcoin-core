...
bool CWallet::SetAddressBook(const CTxDestination& address, const string& strName, const string& pubKeyHex, const string& strPurpose)
{
                ...
                bool fWritePubKey=false;
    {
        ...
        if (!pubKeyHex.empty()) { // пукей не пуст
    ...
    NotifyAddressBookChanged(this, address, strName, pubKeyHex, ::IsMine(*this, address) != ISMINE_NO,
...
bool CWallet::DelAddressBook(const CTxDestination& address)
{
    ...
    CWalletDB(strWalletFile).ErasePubKeyHex(CBitcoinAddress(address).ToString());
