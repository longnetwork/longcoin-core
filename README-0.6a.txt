...
- Хард-Форк наступает на блоке 115000:
	...
	- Целевая Скорость генерации блоков - 2 блок в минуту;
...
- Теперь мультиплексные транзакции работают не как цепочка одноадресных а как одна транзакция с множеством выходов, что незначительно снижает комиссию пулов за выплаты;
